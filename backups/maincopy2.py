...
def newuser_submit():
  ...
  newuser_window.geometry("300x220")
  ...
  height_label.grid(row=6, column=0, padx=30)
  ...
  weight_label.grid(row=7, column=0, padx=30)
  weight_entry = Entry(newuser_window, width=15)
  weight_entry.grid(row=7, column=1)

  #calculate BMI
  bmi_label = Label(newuser_window, text="BMI:", bg="white")
  bmi_label.grid(row=8, column=0)
  bmi_entry = Entry(newuser_window, width=15, bg="grey")
  bmi_entry.config(state="disable")
  ...
  submitaccount_button.grid(row=9,column=0, columnspan=2)
